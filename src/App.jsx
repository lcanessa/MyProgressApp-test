...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <main ref={app.mainRef} className="flex-1 w-full relative z-10 [mask-image:linear-gradient(to_bottom,transparent_0%,black_2rem,black_calc(100%-4rem),transparent_100%)]">
